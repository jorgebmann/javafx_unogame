...
/**
 * Declaration of left window of scene. Gives a label and a picture to computer player. Sets the cards that 
 * are shown on the back side.
 * 
 */
public class CardBoxLeft extends HBox {
    ...
    public CardBoxLeft(Player player) throws FileNotFoundException {

        this.player = player;
        Label labelName = new Label("Computer1");
        FileInputStream inputstream = new FileInputStream("images/faces/emoji1.png");
        ...
        this.getChildren().addAll(cardsVBox, imageBox);
    ...
    public void setCards() throws FileNotFoundException {
    	 for (Card card : this.player.getPlayerCards()) {
        	FileInputStream inputstream = new FileInputStream("images/UNO-Back-left.png");
            Image image = new Image(inputstream);
    ...
    public void addCard(Card card) throws FileNotFoundException {
        ...
        cardImageView.setFitHeight(68);
        this.userCards.add(cardImageView);
//        System.out.println("Size of left card box: " + userCards.size());
